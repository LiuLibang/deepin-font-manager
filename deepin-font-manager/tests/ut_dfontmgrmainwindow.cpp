...
{
    Stub s;
    s.set(ADDR(DFontPreviewListDataThread, onFileAdded), stub_return);

    QSignalSpy spy(DFontPreviewListDataThread::instance(), SIGNAL(requestAdded(const QStringList &, bool)));
